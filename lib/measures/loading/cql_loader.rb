module Measures
  ...
  class CqlLoader < BaseLoaderDefinition
    ...
    def self.process_cql(files, main_cql_library, user, vsac_user=nil, vsac_password=nil, overwrite_valuesets=nil, cache=nil, includeDraft=nil, ticket_granting_ticket=nil)
